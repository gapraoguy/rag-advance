...
from domain.services.faq_chunk_strategies.category_unified_chunk_strategy import CategoryUnifiedChunkStrategy
...
class FAQChunkService:
    ...
    def _get_strategy(self, strategy_name: str) -> FAQChunkStrategy:
        ...
        if strategy_name not in self._strategies:
            ...
            raise ValueError(f"Unknown FAQ strategy: {strategy_name}. Available strategies: {available}")
