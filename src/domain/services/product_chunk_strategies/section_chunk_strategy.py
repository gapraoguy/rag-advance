...
説明: {product.description}"""
        ...
        metadata.update({"chunk_type": "section", "chunk_section": "basic_info"})
...
{features_text}"""
        ...
        metadata = self._create_base_metadata(product)
        metadata.update({"chunk_type": "section", "chunk_section": "features"})

        return Chunk(text=text, metadata=metadata, chunk_id=f"{product.product_id}_features")
...
{specs_text}"""
        ...
        metadata = self._create_base_metadata(product)
        metadata.update({"chunk_type": "section", "chunk_section": "specifications"})
